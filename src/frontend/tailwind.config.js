  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        tulip: {
          mauve: "oklch(var(--tulip-mauve))",
          "mauve-dark": "oklch(var(--tulip-mauve-dark))",
          rose: "oklch(var(--tulip-rose))",
          gold: "oklch(var(--tulip-gold))",
          "gold-dark": "oklch(var(--tulip-gold-dark))",
          cream: "oklch(var(--tulip-cream))",
          "cream-deep": "oklch(var(--tulip-cream-deep))",
          brown: "oklch(var(--tulip-brown))",
          dark: "oklch(var(--tulip-dark))",
        },
      },
      fontFamily: {
